...
This project aims to predict the potability of water using a ML integrated with DVC (Data Version Control) for managing datasets, experiments, and pipelines.
