...
This project aims to predict the potability of water using a M L model integrated with DVC (Data Version Control) for managing datasets, experiments, and pipelines.
